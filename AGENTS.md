...
1. This environment uses JDK 25, where Mockito cannot self-attach its Byte Buddy agent. Run Maven tests that use
   Mockito with
   `-DargLine=-javaagent:/home/balu/.m2/repository/net/bytebuddy/byte-buddy-agent/1.18.11/byte-buddy-agent-1.18.11.jar`.
   Do not first retry the same tests without this agent.
