...
public interface CommentRepository extends JpaRepository<Comment, UUID> {
    ...
    @Query("select c from Comment c join fetch c.currentRevision left join fetch c.ownerAvatarMediaFile"
    ...
    @Query("select c from Comment c left join fetch c.currentRevision left join fetch c.ownerAvatarMediaFile"
