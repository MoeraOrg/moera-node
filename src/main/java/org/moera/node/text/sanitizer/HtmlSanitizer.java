...
public class HtmlSanitizer {
    ...
    private static final PolicyFactory BASIC_HTML = new HtmlPolicyBuilder()
        .allowElements(
            "address", "aside", "footer", "header", "hgroup", "nav", "section", "blockquote", "dd", "div", "dl",
            "dt", "figcaption", "figure", "hr", "li", "ol", "p", "pre", "ul", "a", "abbr", "b", "bdi", "bdo", "br",
            "cite", "code", "data", "dfn", "em", "i", "kbd", "mark", "q", "rb", "rp", "rt", "rtc", "ruby", "s", "samp",
            "small", "span", "strong", "sub", "sup", "time", "u", "var", "wbr", "caption", "col", "colgroup", "table",
            "tbody", "td", "tfoot", "th", "thead", "tr", "img", "del", "ins", "details", "summary", "mr-spoiler",
            "mr-spoiler-block", "iframe", "video", "audio"
        )
        ...
        .allowAttributes(
            "width", "height", "frameborder", "allow", "allowfullscreen", "sandbox", "scrolling",
    ...
    private static final PolicyFactory SAFE_HTML = BASIC_HTML.and(
    ...
    private static final PolicyFactory SAFE_PREVIEW_HTML = BASIC_HTML.and(
        new HtmlPolicyBuilder()
            .allowElements(
                    (elementName, attrs) -> "b",
                    "h1", "h2", "h3", "h4", "h5", "h6")
    ...
    private static boolean validateIframeSrc(String src) {
        String hostname = UriComponentsBuilder.fromUriString(src).build().getHost();
